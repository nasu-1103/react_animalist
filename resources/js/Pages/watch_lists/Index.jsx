                    ...
                    {animeGroup.animes.map(anime =>
                        <tr key={anime.id} className="text-center">
                            ...
                            <td className="border border-slate-300 px-6 py-4">
                                ...
                                {
                                    new Date(anime.watchlists?.created_at).getFullYear() + '-' +
                                    ('0' + (new Date(anime.watchlists?.created_at).getMonth() + 1)).slice(-2) + '-' +
                                    ('0' + (new Date(anime.watchLists?.created_at).getDate())).slice(-2)
                                }
                            </td>
                            <td className="border border-slate-300 px-6 py-4">
